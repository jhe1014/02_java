...
/**
 * 기본형 <==> 참조형 데이터를 서로 변환할 수 있도록 하는 포장 클래스 중
 * int : Integer
 * double : Double
 * 
 * 두 가지 포장클래스를 테스트
...
public class IntDoubleWrapper {
	...
	public static void main(String[] args) {
		...
		// String 변경 확인을 위하여 String의 + 연산 시도
		tenStr += "입니다.";
		sixtyStr += "입니다.";
		...
		// autoUnboxing : 참조형 인스턴스가 기본형 변수에 변환 메소드 호출없이 바로 담기는 기법
		// autoBoxing : 기본형 데이터가 참조형 변수에 new 없이 바로 담기는 기법
		
		// (1) autoBoxing 적용 전 : 반드시 포장클래스의 생성자를 사용해야 함
		Integer objOne = new Integer(1);
		
		// (2) autoBoxing 적용 후 : 포장클래스 변수를 마치 기본형 변수인 듯 기본형 값을 바로 저장할 수 있음
		Integer objFive = 5;
