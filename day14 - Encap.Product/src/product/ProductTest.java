...
public class ProductTest {
	...
	public static void main(String[] args) {
		// 1. 선언 : 제품을 사용하기 위한 객체 참조 변수
				...
				// Product의 각 필드에 access modifier 생략 시 가능
				/*
				 * airFrier.pcode = "P002"; airFrier.pname = "[필립스] 에어프라이어 HD-9743";
				 * airFrier.price = 329000; airFrier.quantity = 5;
				 */
				
				// Product의 각 필드에 access modifier private인 경우 반드시 수정자에 의해서만 접근 가능
				...
				System.out.printf("제품 가격 : %d,  20%% 할인가 : %d" , 51330, dcPrice);
